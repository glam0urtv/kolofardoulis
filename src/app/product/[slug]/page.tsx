...
export default function ProductPage() {
  ...
  useEffect(() => {
    ...
    if (!BASE || !KEY) return
    fetch(`${BASE}/rest/v1/Product?select=*,inventory(stock)&slug=eq.${slug}`, {
  ...
  if (!product) return <div className="flex flex-col items-center justify-center py-20 text-stone-400"><span className="text-5xl">🔍</span><p className="mt-4 text-lg">Το προϊόν δεν βρέθηκε</p></div>
